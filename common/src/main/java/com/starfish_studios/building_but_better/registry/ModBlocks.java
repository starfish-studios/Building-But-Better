...
public class ModBlocks {
    ...
    // region BLOCKS
    public static final Supplier<Block> STONE_BLOCK = registerBlockOnly("stone_block", () -> new BlockBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE).pushReaction(PushReaction.DESTROY)));
    public static final Supplier<Block> WALL_STONE_BLOCK = registerBlockOnly("wall_stone_block", () -> new WallBlockBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE).pushReaction(PushReaction.DESTROY).dropsLike(STONE_BLOCK.get())));
    public static final Supplier<Block> BLACKSTONE_BLOCK = registerBlockOnly("blackstone_block", () -> new BlockBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BLACKSTONE).pushReaction(PushReaction.DESTROY)));
    public static final Supplier<Block> WALL_BLACKSTONE_BLOCK = registerBlockOnly("wall_blackstone_block", () -> new WallBlockBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BLACKSTONE).pushReaction(PushReaction.DESTROY).dropsLike(BLACKSTONE_BLOCK.get())));
    public static final Supplier<Block> DEEPSLATE_BLOCK = registerBlockOnly("deepslate_block", () -> new BlockBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.DEEPSLATE).pushReaction(PushReaction.DESTROY)));
    public static final Supplier<Block> WALL_DEEPSLATE_BLOCK = registerBlockOnly("wall_deepslate_block", () -> new WallBlockBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.DEEPSLATE).pushReaction(PushReaction.DESTROY).dropsLike(DEEPSLATE_BLOCK.get())));
    public static final Supplier<Block> NETHER_BRICK_BLOCK = registerBlockOnly("nether_brick_block", () -> new BlockBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.NETHER_BRICKS).pushReaction(PushReaction.DESTROY)));
    public static final Supplier<Block> WALL_NETHER_BRICK_BLOCK = registerBlockOnly("wall_nether_brick_block", () -> new WallBlockBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.NETHER_BRICKS).pushReaction(PushReaction.DESTROY).dropsLike(NETHER_BRICK_BLOCK.get())));
    public static final Supplier<Block> SANDSTONE_BLOCK = registerBlockOnly("sandstone_block", () -> new BlockBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.SANDSTONE).pushReaction(PushReaction.DESTROY)));
    public static final Supplier<Block> WALL_SANDSTONE_BLOCK = registerBlockOnly("wall_sandstone_block", () -> new WallBlockBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.SANDSTONE).pushReaction(PushReaction.DESTROY).dropsLike(SANDSTONE_BLOCK.get())));
    public static final Supplier<Block> RED_SANDSTONE_BLOCK = registerBlockOnly("red_sandstone_block", () -> new BlockBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.RED_SANDSTONE).pushReaction(PushReaction.DESTROY)));
    public static final Supplier<Block> WALL_RED_SANDSTONE_BLOCK = registerBlockOnly("wall_red_sandstone_block", () -> new WallBlockBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.RED_SANDSTONE).pushReaction(PushReaction.DESTROY).dropsLike(RED_SANDSTONE_BLOCK.get())));
    public static final Supplier<Block> QUARTZ_BLOCK = registerBlockOnly("quartz_block", () -> new BlockBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.QUARTZ_BLOCK).pushReaction(PushReaction.DESTROY)));
    public static final Supplier<Block> WALL_QUARTZ_BLOCK = registerBlockOnly("wall_quartz_block", () -> new WallBlockBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.QUARTZ_BLOCK).pushReaction(PushReaction.DESTROY).dropsLike(QUARTZ_BLOCK.get())));
    // endregion
