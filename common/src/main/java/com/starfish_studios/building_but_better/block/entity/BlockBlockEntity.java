package com.starfish_studios.building_but_better.block.entity;

import com.starfish_studios.building_but_better.registry.ModBlockEntityTypes;
...
public class BlockBlockEntity extends BlockEntity {
    ...
    public BlockBlockEntity(BlockPos blockPos, BlockState blockState) {
        super(ModBlockEntityTypes.BLOCK.get(), blockPos, blockState);
    }
