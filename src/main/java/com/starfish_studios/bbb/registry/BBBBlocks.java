...
public class BBBBlocks {
    ...
    //region LADDERS
    public static final Block OAK_LADDER = register("oak_ladder", new BBBLadderBlock(1, BlockBehaviour.Properties.copy(Blocks.LADDER)));
    public static final Block SPRUCE_LADDER = register("spruce_ladder", new BBBLadderBlock(2, BlockBehaviour.Properties.copy(Blocks.LADDER)));
    public static final Block BIRCH_LADDER = register("birch_ladder", new BBBLadderBlock(3, BlockBehaviour.Properties.copy(Blocks.LADDER)));
    public static final Block JUNGLE_LADDER = register("jungle_ladder", new BBBLadderBlock(4, BlockBehaviour.Properties.copy(Blocks.LADDER)));
    public static final Block ACACIA_LADDER = register("acacia_ladder", new BBBLadderBlock(5, BlockBehaviour.Properties.copy(Blocks.LADDER)));
    public static final Block DARK_OAK_LADDER = register("dark_oak_ladder", new BBBLadderBlock(6, BlockBehaviour.Properties.copy(Blocks.LADDER)));
    public static final Block CRIMSON_LADDER = register("crimson_ladder", new BBBLadderBlock(7, BlockBehaviour.Properties.copy(Blocks.LADDER)));
    public static final Block WARPED_LADDER = register("warped_ladder", new BBBLadderBlock(8, BlockBehaviour.Properties.copy(Blocks.LADDER)));
    public static final Block MANGROVE_LADDER = register("mangrove_ladder", new BBBLadderBlock(9, BlockBehaviour.Properties.copy(Blocks.LADDER)));
    ...
    public static final Block CHERRY_LADDER = register("cherry_ladder", new BBBLadderBlock(10, BlockBehaviour.Properties.copy(Blocks.LADDER)));
    //endregion
    ...
    // public static final Block COPPER_GATEWAY = register("copper_gateway", new GatewayBlock(FabricBlockSettings.copy((Blocks.OAK_DOOR)).noOcclusion()));
