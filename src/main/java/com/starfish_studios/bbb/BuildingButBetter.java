...
public class BuildingButBetter implements ModInitializer {
	...
	public void onInitialize() {
		...
		Util.make(new LinkedHashMap<Block, Block>(), pairs -> {
			...
			pairs.put(BBBBlocks.EXPOSED_CUT_COPPER_LAYER, BBBBlocks.WAXED_EXPOSED_CUT_COPPER_LAYER);
			pairs.put(BBBBlocks.WEATHERED_CUT_COPPER_LAYER, BBBBlocks.WAXED_WEATHERED_CUT_COPPER_LAYER);
			pairs.put(BBBBlocks.OXIDIZED_CUT_COPPER_LAYER, BBBBlocks.WAXED_OXIDIZED_CUT_COPPER_LAYER);
