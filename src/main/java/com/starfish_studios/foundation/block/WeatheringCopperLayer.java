...
public interface WeatheringCopperLayer extends ChangeOverTimeBlock<WeatheringCopperLayer.WeatherState> {
    Supplier<ImmutableBiMap<Object, Object>> NEXT_BY_BLOCK = Suppliers.memoize(() -> ((ImmutableBiMap.builder().put(FoundationBlocks.CUT_COPPER_LAYER, FoundationBlocks.EXPOSED_CUT_COPPER_LAYER)).put(FoundationBlocks.EXPOSED_CUT_COPPER_LAYER, FoundationBlocks.WEATHERED_CUT_COPPER_LAYER)).put(FoundationBlocks.WEATHERED_CUT_COPPER_LAYER, FoundationBlocks.OXIDIZED_CUT_COPPER_LAYER).build());
